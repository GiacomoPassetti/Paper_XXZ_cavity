...
cd $HOME/DMRG/MF/Broken_symmetry
...
python3 mf.py $g $L $imp


echo \$?

date
" >$HOME/DMRG/MF/Broken_symmetry/Bash/addBash_GSs

sbatch <$HOME/DMRG/MF/Broken_symmetry/Bash/addBash_GSs
